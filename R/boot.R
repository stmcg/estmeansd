...
#'
#' @references McGrath S., Katzenschlager S., Zimmer A.J., Seitel A., Denkinger C.M., Steele R., Benedetti A. (In preparation). Standard error estimation in meta-analysis of studies reporting medians.
#'
#' @export
get_SE <- function(x, ...){
  UseMethod("get_SE")
